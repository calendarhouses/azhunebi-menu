...
const stepperButtonClass =
  "flex h-9 w-9 shrink-0 touch-pan-y items-center justify-center rounded-full bg-brand-surface-elevated text-lg leading-none text-brand-accent transition-all duration-200 hover:bg-brand-surface active:scale-95";
    ...
    <div className={`relative h-9 ${STEPPER_WIDTH} ${className}`}>
      <div className="grid h-9 place-items-center">
        <button
          ...
          className={`col-start-1 row-start-1 inline-flex h-9 w-full touch-pan-y items-center justify-center rounded-xl bg-brand-accent text-xs font-semibold text-brand-accent-text transition-all duration-200 hover:bg-brand-accent-hover active:scale-[0.98] ${
            showStepper
